...
void Joystick::_loadAxisSettings(bool calibrated, int transmitterMode)
{
    ...
    if (rollFunctionNotAssigned || pitchFunctionNotAssigned || yawFunctionNotAssigned || throttleFunctionNotAssigned ||
        ...
        qCDebug(JoystickLog) << "Missing control axis function(s), resetting all axis settings, marking joystick as uncalibrated and disabled";
        _resetAxisCalibrationData();
        _clearAxisSettings();
        _joystickSettings.calibrated()->setRawValue(false);
...
void Joystick::_saveAxisSettings(bool calibrated, int transmitterMode)
{
    qCDebug(JoystickLog) << name();
...
void Joystick::_saveFromCalibrationDataIntoSettings()
{
    ...
    _clearAxisSettings();
    if (calibrated) {
        _saveAxisSettings(calibrated, transmitterMode);
    }
