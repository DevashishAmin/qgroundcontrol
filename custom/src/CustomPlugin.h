...
public:
    ...
    // Branding overrides
    QString brandImageIndoor() const final { return QStringLiteral("/custom/img/BattleLabLogo.svg"); }
    QString brandImageOutdoor() const final { return QStringLiteral("/custom/img/BattleLabLogo.svg"); }
